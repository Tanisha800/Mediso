    ...
    <div className="group bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 hover:border-emerald-400/30 backdrop-blur-sm relative overflow-hidden flex flex-col h-full">
      ...
      <div className="pt-6 mt-auto">
        <Button
          ...
          variant="outline"
          className="w-full h-11 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-emerald-50 dark:hover:bg-emerald-900/10 hover:text-emerald-600 hover:border-emerald-200 font-semibold transition-all text-xs uppercase tracking-widest"
        >
          View Details
        </Button>
      </div>
