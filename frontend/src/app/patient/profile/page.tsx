      ...
      <div className="space-y-8 animate-in fade-in duration-500 max-w-[1000px] mx-auto pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Button 
            ...
            variant="destructive"
            className="h-11 rounded-xl bg-rose-100 hover:bg-rose-200 text-rose-700 dark:bg-rose-900/30 dark:hover:bg-rose-900/50 dark:text-rose-400 font-semibold uppercase tracking-widest text-xs px-6 transition-all"
          >
        ...
        {successMsg && (
          <div className="flex items-center gap-3 p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 text-sm font-semibold border border-emerald-100 dark:border-emerald-900/30 animate-in slide-in-from-top-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="bg-white dark:bg-slate-900/50 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
              ...
              {pwdError && (
                <div className="mb-4 p-3 rounded-xl bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 text-xs font-semibold border border-rose-100 dark:border-rose-900/30">
                  {pwdError}
                </div>
              )}
              {pwdSuccess && (
                <div className="mb-4 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 text-xs font-semibold border border-emerald-100 dark:border-emerald-900/30">
                  {pwdSuccess}
                </div>
              )}
              ...
              <form onSubmit={handleChangePassword} className="space-y-4">
                ...
                <Button 
                  ...
                  className="w-full h-11 rounded-xl bg-slate-900 hover:bg-slate-800 text-white dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 font-semibold uppercase tracking-widest text-[10px]"
                >
